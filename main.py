...
text_phrases = {
    ...
    'rules': ['Я могу рассказать вам последние вопросы Любичу на спрашивай, '
              ...
              'Так же я могу задать вопрос Геннадию Любичу. '
              'Для этого скажите: "Задай вопрос". '
              'В следующем "сообщении" озвучьте ваш вопрос, и '
              'он отправится в точно таком же виде, в каком вы его озвучили. '
              'Для отмены действия после фразы: "Задай вопрос" скажите: "Отмена" или "Хватит" или сверните навык'],

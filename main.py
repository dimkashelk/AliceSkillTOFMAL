...
text_phrases = {
    'begin_phrase': ['Привет! Спроси у меня про спрашивай',
                     'Здравствуйте, давайте узнаем, что нового на лицейском сайте',
                     'Здравствуйте. Спросите про вопросы на спрашивай, а я отвечу',
                     'Привет, начнем? Просто спроси, что нового на сайте лицея'],
